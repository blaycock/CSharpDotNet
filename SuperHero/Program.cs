...
namespace SuperHero
{
    class Program
    {
        ...
        class SuperHero : Person
        {
            ...
            public SuperHero(string sName, string sRealName, string sSuperPower) : base(sName, null)
            {
                Name = sName;
                RealName = sRealName;
            ...
            {
                return Name + ": I am " + RealName + ". When I am " + Name + ", my super power is\n " + SuperPower + "!\n";
            }
        }
        ...
        class Villain : Person
        {
            ...
            public Villain(string vName, string vNemesis) : base(vName, null)
            {
                VillainName = vName;
                Nemesis = vNemesis;
            }
            ...
            public override string PrintGreeting()
            {
                return Name + ": I am " + VillainName + " have you seen " + Nemesis + "?\n";
            }
        }
